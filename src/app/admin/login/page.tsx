    ...
    <div className="min-h-screen bg-[#060B27] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black text-white mb-2">ListNexa Admin</h1>
        ...
        <form onSubmit={handleLogin} className="bg-[#0B1354] rounded-2xl p-8 border border-[#1B2F8C] shadow-2xl">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#FBBF24] text-[#060B27] py-3 rounded-lg font-black hover:bg-amber-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
