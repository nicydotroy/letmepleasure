...
export const CATEGORIES: Category[] = [
  ...
  { name: 'Male Escorts', slug: 'male-escorts', icon: '👨', color: 'bg-blue-100 text-blue-700' },
  ...
  { name: 'Male Massage', slug: 'male-massage', icon: '💆‍♂️', color: 'bg-indigo-100 text-indigo-700' },
]
